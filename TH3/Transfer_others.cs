...
namespace TH3
{
    public partial class Transfer_others : Form
    {
        private Transfer transfer;
        public Transfer_others(Transfer transfer)
        {
            InitializeComponent();
        ...
        private void textBox2_taiKhoanThuaHuong_Leave(object sender, EventArgs e)
        {
            string SoTK = textBox2_taiKhoanThuaHuong.Text;
            int soTaiKhoan;
